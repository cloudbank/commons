...
import com.droidteahouse.commons.service.FlickrService;
import com.droidteahouse.commons.service.ServiceGenerator;
...
public class FlickrClientApp extends MultiDexApplication {
  ...
  public static FlickrService getJacksonService() {
    if (jacksonService == null) {
      jacksonService =createJacksonService(getConsumer());
    }
  ...
  public static FlickrService createJacksonService(OkHttpOAuthConsumer consumer) {
    jacksonService = ServiceGenerator.createRetrofitRxService(consumer, com.droidteahouse.commons.service.FlickrService.class, baseUrl, JacksonConverterFactory.create());
    return jacksonService;
  }
